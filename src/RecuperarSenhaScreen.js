...
import { View, Text, TextInput, Button, StyleSheet, Alert, Image, TouchableOpacity, windowWidth } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        />
        {(senhaFoco || novaSenha.length > 0) && ( // o length pega o número de caracteres que uma string tem. Sendo assim, se length for maior que 0, o usuário já digitou alguma caracter, logo já pode aparecer o olhinho.
          <TouchableOpacity
      ...
      <TouchableOpacity style={styles.estiloBotao} onPress={handlesalvarNovaSenha}>
